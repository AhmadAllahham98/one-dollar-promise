...
export const InputBox = ({
    ...
    const containerBase = 'flex flex-col bg-surface-white border-2 border-surface-200 transition-all focus-within:border-black/5';
    ...
    const textareaStyles = 'w-full bg-transparent text-content-inverse border-none focus:outline-none focus:ring-0 resize-none placeholder:text-black/40';

    const textFont = size === 'large' ? 'font-interface-md' : 'font-interface-sm';
    const counterFont = size === 'large' ? 'font-interface-md' : 'font-interface-sm';
